...
package com.halvors.WolfControl.commands;
 ...
 * @author halvors
 */
public class WolfControlCommandExecutor implements CommandExecutor {
	...
	public WolfControlCommandExecutor(final WolfControl plugin) {
		this.plugin = plugin;
